...
import com.drprog.happystory.db.utils.DbUtils;
...
public abstract class SQLBaseTable<T> {
    public static final String CONTENT_AUTHORITY = "com.karmaplatform.module.settings.provider";
    ...
    protected abstract ContentValues convertToCV(final T item);
